...
public class GameRepositoryIntegrationTests {
    ...
    public void testThatGameCanBeCreatedAndRecalled() {
        GameEntity gameEntityA = TestData.GameEntityUtils.createA(userRepo);
    ...
    public void testThatMultipleGamesCanBeCreatedAndRecalled() {
        ...
        GameEntity gameEntityB = TestData.GameEntityUtils.createB(userRepo);
        gameRepo.save(gameEntityB);

        GameEntity gameEntityC = TestData.GameEntityUtils.createC(userRepo);
